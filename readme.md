...
This telegram bot retrieves and sends new Instagram stories of a target profile to a Telegram chat anonymously. It utilizes Instaloader to scrape Instagram data, it filters and sends only new stories.
